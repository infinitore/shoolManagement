...
export const EtudiantDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/etudiant' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shoolManagementApp.etudiant.delete.question">
        <Translate contentKey="shoolManagementApp.etudiant.delete.question" interpolate={{ id: etudiantEntity.id }}>
