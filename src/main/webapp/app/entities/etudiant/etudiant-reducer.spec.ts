...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './etudiant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETUDIANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETUDIANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETUDIANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ETUDIANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ETUDIANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ETUDIANT actions', async () => {
      const arg = 42666;
