...
export const CoursDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/cours' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shoolManagementApp.cours.delete.question">
        <Translate contentKey="shoolManagementApp.cours.delete.question" interpolate={{ id: coursEntity.id }}>
