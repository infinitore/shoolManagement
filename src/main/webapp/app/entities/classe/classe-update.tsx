...
export const ClasseUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/classe' + location.search);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shoolManagementApp.classe.home.createOrEditLabel" data-cy="ClasseCreateUpdateHeading">
            <Translate contentKey="shoolManagementApp.classe.home.createOrEditLabel">Create or edit a Classe</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('shoolManagementApp.classe.nom')}
                id="classe-nom"
                name="nom"
                data-cy="nom"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('shoolManagementApp.classe.niveau')}
                id="classe-niveau"
                name="niveau"
                data-cy="niveau"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('shoolManagementApp.classe.anneeScolaire')}
                id="classe-anneeScolaire"
                name="anneeScolaire"
