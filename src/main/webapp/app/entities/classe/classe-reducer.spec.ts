...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSE actions', async () => {
      const arg = 42666;
