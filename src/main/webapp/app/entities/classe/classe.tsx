...
export const Classe = () => {
  ...
  const totalItems = useAppSelector(state => state.classe.totalItems);
  ...
  return (
    <div>
      <h2 id="classe-heading" data-cy="ClasseHeading">
        <Translate contentKey="shoolManagementApp.classe.home.title">Classes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="shoolManagementApp.classe.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/classe/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="shoolManagementApp.classe.home.createLabel">Create new Classe</Translate>
          </Link>
        </div>
      </h2>
        ...
        {classeList && classeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="shoolManagementApp.classe.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('anneeScolaire')}>
                  <Translate contentKey="shoolManagementApp.classe.anneeScolaire">Annee Scolaire</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('anneeScolaire')} />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/classe/${classe.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/classe/${classe.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="shoolManagementApp.classe.home.notFound">No Classes found</Translate>
            </div>
          )
        )}
      </div>
      {totalItems ? (
        <div className={classeList && classeList.length > 0 ? '' : 'd-none'}>
