...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENSEIGNANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENSEIGNANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENSEIGNANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENSEIGNANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENSEIGNANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENSEIGNANT actions', async () => {
      const arg = 42666;
